...
func (_Pv0Smartcontract *Pv0SmartcontractCaller) MinIntervalBetweenVotes(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Pv0Smartcontract.contract.Call(opts, &out, "minIntervalBetweenVotes")
...
//
// Solidity: function minIntervalBetweenVotes() view returns(uint256)
func (_Pv0Smartcontract *Pv0SmartcontractSession) MinIntervalBetweenVotes() (*big.Int, error) {
	return _Pv0Smartcontract.Contract.MinIntervalBetweenVotes(&_Pv0Smartcontract.CallOpts)
}

// MinIntervalBetweenVotes is a free data retrieval call binding the contract method 0xf99ac2c2.
//
// Solidity: function minIntervalBetweenVotes() view returns(uint256)
func (_Pv0Smartcontract *Pv0SmartcontractCallerSession) MinIntervalBetweenVotes() (*big.Int, error) {
	return _Pv0Smartcontract.Contract.MinIntervalBetweenVotes(&_Pv0Smartcontract.CallOpts)
}
...
func (_Pv0Smartcontract *Pv0SmartcontractCaller) VotedOnProposal(opts *bind.CallOpts, arg0 [32]byte) (bool, error) {
	var out []interface{}
...
//
// Solidity: function votedOnProposal(bytes32 ) view returns(bool)
func (_Pv0Smartcontract *Pv0SmartcontractSession) VotedOnProposal(arg0 [32]byte) (bool, error) {
...
//
// Solidity: function votedOnProposal(bytes32 ) view returns(bool)
func (_Pv0Smartcontract *Pv0SmartcontractCallerSession) VotedOnProposal(arg0 [32]byte) (bool, error) {
	return _Pv0Smartcontract.Contract.VotedOnProposal(&_Pv0Smartcontract.CallOpts, arg0)
}
...
func (_Pv0Smartcontract *Pv0SmartcontractTransactor) SetMinIntervalBetweenVotes(opts *bind.TransactOpts, newMinInterval *big.Int) (*types.Transaction, error) {
	return _Pv0Smartcontract.contract.Transact(opts, "setMinIntervalBetweenVotes", newMinInterval)
}

// SetMinIntervalBetweenVotes is a paid mutator transaction binding the contract method 0x2714e22f.
//
// Solidity: function setMinIntervalBetweenVotes(uint256 newMinInterval) returns()
func (_Pv0Smartcontract *Pv0SmartcontractSession) SetMinIntervalBetweenVotes(newMinInterval *big.Int) (*types.Transaction, error) {
	return _Pv0Smartcontract.Contract.SetMinIntervalBetweenVotes(&_Pv0Smartcontract.TransactOpts, newMinInterval)
}

// SetMinIntervalBetweenVotes is a paid mutator transaction binding the contract method 0x2714e22f.
//
// Solidity: function setMinIntervalBetweenVotes(uint256 newMinInterval) returns()
func (_Pv0Smartcontract *Pv0SmartcontractTransactorSession) SetMinIntervalBetweenVotes(newMinInterval *big.Int) (*types.Transaction, error) {
	return _Pv0Smartcontract.Contract.SetMinIntervalBetweenVotes(&_Pv0Smartcontract.TransactOpts, newMinInterval)
}
